...
Модератори працюють з клієнтами та роблять оцінку експертів, які працюють над питанням клієнта. Експерти надають експертну оцінку з питання клієнта.
    5.	**Користувацькі сценарії**  
        1.	**Сценарій реєстрації експерта**  
            ...
            Виключні випадки:
            1.	Може виникнути через недостатню кваліфікацію експерта. Тоді модератор може відхилити заяву.
            2.	Може виникнути відхилення заявки через наявність уже створеного аканта у даного користувача. В такому випадку система надсилає клієну повідомлення про неможливіть створення нового акаунта.
        2.	**Сценарій реєстрації клієнта[того, хто подає заяву на оцінку?]**  
            ...
            Виключні випадки:
            1.	Може виникнути відхилення заявки через наявність уже створеного аканта у даного користувача. В такому випадку система надсилає клієну повідомлення про неможливіть створення нового акаунта.
